...
module Query =
    ...
    let findAndModify (collection: string) =
        FindAndModifyBuilder(collection, Serialize)
    ...
    let find (collection: string) = FindBuilder(collection, Serialize)
    ...
    let delete (collection: string) = DeleteBuilder(collection, Serialize)
    ...
    let insert (collection: string) =
        InsertCommandBuilder(collection, Serialize)
    ...
    let update (collection: string) =
        UpdateCommandBuilder(collection, Serialize)
